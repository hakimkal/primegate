...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'events_event', 'cropping',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'events_event', 'cropping')
    ...
    models = {
        ...
        u'events.event': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('django.db.models.fields.files.ImageField', [], {'default': "'events_images/None/no-img.jpg'", 'max_length': '100'}),
